...
function App() {
  ...
  return (
    <div
      className="App flex flex-col items-center justify-center h-screen bg-neutral-800
...
//useCallback function can be used to memoize generatePassword function to prevent unnecessary re-creations on each render.
...
//   if (symbolAllowed) characterPool += symbols;
